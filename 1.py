...
# 保存详细分析结果到文件
with open('sentiment_analysis_results.txt', 'w', encoding='utf-8-sig') as f:
    f.write("情感分析详细结果\n")
    f.write("==============\n\n")
...
print("\n详细分析结果已保存到 sentiment_analysis_results.txt")
